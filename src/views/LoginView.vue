<template>
    <div class="flex flex-col items-center justify-start h-full w-full bg-primary">
        <div class="relative w-full h-1/2">
            <img src="@/assets/img/sign-in.png" alt="sign-in" class="absolute z-30 top-0 w-full">
            <img src="@/assets/img/wave-top.png" alt="wave-top" class="absolute z-10 top-0 w-full">
        </div>
        <div class="px-6 w-full text-white">
            ...
            <div class="mb-2">
                ...
                <input id="username" type="text" placeholder="Masukkan username anda"
                    class="w-full p-4 rounded-lg mt-2 text-12 font-medium">
            </div>
            <div class="mb-3">
            ...
            <BaseButton text="Masuk" background="dark-blue" class="mb-1"/>
